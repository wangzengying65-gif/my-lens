var Render = (function () {
  ...
  var PLACEHOLDER_SVGS = [
    '<svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="g1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#7c3aed" stop-opacity="0.3"/><stop offset="100%" stop-color="#3b82f6" stop-opacity="0.15"/></linearGradient></defs><rect width="400" height="300" fill="url(#g1)"/><circle cx="200" cy="130" r="40" fill="none" stroke="rgba(255,255,255,0.1)" stroke-width="2"/><polygon points="188,118 188,142 218,130" fill="rgba(255,255,255,0.15)"/></svg>',
    '<svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="g2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#06b6d4" stop-opacity="0.3"/><stop offset="100%" stop-color="#7c3aed" stop-opacity="0.15"/></linearGradient></defs><rect width="400" height="300" fill="url(#g2)"/><circle cx="200" cy="130" r="40" fill="none" stroke="rgba(255,255,255,0.1)" stroke-width="2"/><polygon points="188,118 188,142 218,130" fill="rgba(255,255,255,0.15)"/></svg>',
    '<svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="g3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#f59e0b" stop-opacity="0.25"/><stop offset="100%" stop-color="#ef4444" stop-opacity="0.1"/></linearGradient></defs><rect width="400" height="300" fill="url(#g3)"/><circle cx="200" cy="130" r="40" fill="none" stroke="rgba(255,255,255,0.1)" stroke-width="2"/><polygon points="188,118 188,142 218,130" fill="rgba(255,255,255,0.15)"/></svg>',
    '<svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="g4" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#10b981" stop-opacity="0.25"/><stop offset="100%" stop-color="#06b6d4" stop-opacity="0.1"/></linearGradient></defs><rect width="400" height="300" fill="url(#g4)"/><circle cx="200" cy="130" r="40" fill="none" stroke="rgba(255,255,255,0.1)" stroke-width="2"/><polygon points="188,118 188,142 218,130" fill="rgba(255,255,255,0.15)"/></svg>'
  ];
  ...
  function detail(id) {
    ...
    for (var i = 0; i < post.photos.length; i++) {
      ...
      imgEl.addEventListener('load', function (div) {
        return function () { div.style.display = 'none'; };
      }(placeholderDiv));
      imgEl.addEventListener('error', function (img) {
        return function () { img.style.display = 'none'; };
      }(imgEl));
